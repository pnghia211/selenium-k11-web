...
public class Component {
    ...
    public <T extends Component> List<T> findComponents(Class<T> componentClass, WebDriver driver) {
        ...
        try {
            ...
            throw new IllegalArgumentException("[ERR] Component must have CssSelector");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("[ERR] the component must have a constructor with params"
                    + Arrays.toString(params));
        }

        // Convert all elements into components
    ...
    public void scrollUpToEle(WebElement element) {
        scrollToEle("false", element);
    }

    public void scrollDownToEle(WebElement element) {
        scrollToEle("true", element);
    }

    public void scrollToEle(String position, WebElement element) {
        ((JavascriptExecutor) driver).executeScript
                ("arguments[0].scrollIntoView(" + position + ");", element);
    }
}
